...
# This file is modified version of a file originally taken from 
# Adblock Plus <https://adblockplus.org/>, Copyright (C) 2006-2015 Eyeo GmbH.
#
...
if __name__ == '__main__':
  ...
  data = addVersion(readStream(sys.stdin))
